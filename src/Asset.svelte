...
<div class="assetdiv">
    <div class="leftsidediv">
        <div class="imgcontainer">
            ...
            <img class="assetimg" src={getIPFSURL(assetdata.ipfshash)}/>
        </div>
        <Collapse buttonname="Description">
            <div class="descriptiondiv">
                <span>Created by <a class="replacewithcreator"></a></span>
                <br/>
    ...
    -->
        <Collapse buttonname="About {collectiondata.name}">{collectiondata.description}</Collapse>
    ...
    <div>
        <div class="assetinnerdiv">
            ...
            <br/>
            <div class="assetownerdiv">
                <span>Owned by <UsernamePresenter userid={{id:tokendata.ownerid}}></UsernamePresenter></span><!--<span>Favorites:{assetdata.favorites}</span>-->
            </div>
            ...
            <div class="hodiv">
                <div class="innerhodiv">
                    <h7>Highest offer</h7>
                    <br/>
                    <h4 class="nomargin"><img class="bigethereum" src="ethereum.ico"/>{assetdata.highestprice}</h4>
                    <br/>
                    <!--{#if $SessionData && assetdata.creator == $SessionData.id}-->
                    <button class="makebidbutton" on:click={OnMakeBidButtonClick}>Make Bid</button>
                </div>
            </div>
            <br/>
